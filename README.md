...
عشان الموقع ميبقاش فاضي وقت العرض أو التجربة، فيه سكريبت بينشئ 5 حسابات مطورين وهمية (بأسماء وسير ذاتية عربية واقعية، مش Lorem Ipsum) ومحتوى مرتبط بيهم: منشورات، أسئلة وإجابات (مع إجابة مقبولة)، نقاش، خبرين، وتجربتَي انترفيو، بالإضافة لمتابعات وإعجابات عشان الأرقام متبقاش كلها صفر.
